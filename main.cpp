...
int main()
{
	...
	glfwMakeContextCurrent(window); //중요!!

	//GLEW Init GLEW 초기화 (윈도우와 opengl context가 필요함)
	...
	//OPENGL OPTIONS opengl 옵션들
	glEnable(GL_DEPTH_TEST);

	glEnable(GL_CULL_FACE);
	glCullFace(GL_BACK);
	glFrontFace(GL_CCW); //COUNTER CLOCK WISE 반시계 방향
	...
	//SET VERTEX ATTRIBPOINTERS  AND ENABLE (INPUT ASSEMBLY) | Vertex Attributes 연결
